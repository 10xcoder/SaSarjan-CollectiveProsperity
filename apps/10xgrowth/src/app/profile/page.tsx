...
const ProfileSelector = (_props: any) => <div>Profile Selector placeholder</div>;
const ProfileBuilder = (_props: any) => <div>Profile Builder placeholder</div>;
const useProfile = (_options?: any) => ({ 
  profiles: [],
  currentProfile: null as any,
  loading: false,
  createProfile: (_data?: any) => {},
  selectProfile: (_id?: any) => {},
  importProfile: (_id?: any, _type?: any) => {},
  profile: null, 
