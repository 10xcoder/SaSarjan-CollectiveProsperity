    ...
    <main className="flex min-h-screen flex-col">
      ...
      <section className="flex flex-col items-center justify-center px-4 py-24 text-center">
        ...
        <div className="flex flex-col gap-4 sm:flex-row">
          <button className="rounded-lg bg-incubator-primary px-8 py-3 text-white hover:bg-incubator-primary/90">
            Find Incubators
          </button>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-lg bg-white p-6 shadow-sm">
              <div className="mb-4 h-12 w-12 rounded-lg bg-incubator-primary/10"></div>
            ...
            <div className="rounded-lg bg-white p-6 shadow-sm">
              <div className="mb-4 h-12 w-12 rounded-lg bg-incubator-secondary/10"></div>
              <h3 className="mb-2 text-xl font-semibold">Journey Tracking</h3>
              <p className="text-gray-600">
                Visual roadmap from idea to scale
              </p>
            </div>
            
            <div className="rounded-lg bg-white p-6 shadow-sm">
              <div className="mb-4 h-12 w-12 rounded-lg bg-incubator-startup/10"></div>
