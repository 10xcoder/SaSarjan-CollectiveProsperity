...
export default function SignInForm({ onSuccess, onVerificationRequired, isLoading, setIsLoading }: SignInFormProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {/* Password Input (if not passwordless) */}
        {!isPasswordless && (
          <div className="space-y-2">
        ...
        >
          ...
          {isPasswordless 
            ? `Send Code via ${method === 'email' ? 'Email' : 'WhatsApp'}`
            : 'Sign In'
          }
        </Button>
        ...
        <div className="text-center">
          ...
          >
            {isPasswordless 
              ...
              : `Sign in with ${method === 'email' ? 'email' : 'WhatsApp'} code`
            }
          </Button>
        </div>
